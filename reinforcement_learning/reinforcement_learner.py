...
if __name__ == "__main__":
    ...
    for category in product_categories.keys():
        ...
        if number_of_products > 0:
            real_products += random.sample(category_products, product_categories[category])
    ...
    generated_products = generate_seasonal_data_based_on_products(real_products, 500, 0)
