    ...
    def _get_observation(self):
        ...
        for i, product in enumerate(self.scaled_products):
            ...
            if self.should_include_individual_forecast:
                ...
                observation.append(np.concatenate((historical_demand, [self.inventory_levels[j][i] if j in self.inventory_levels else 0 for j in range(self.current_period-12, self.current_period+1)])))
